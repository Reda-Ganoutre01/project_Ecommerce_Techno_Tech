...
?>                        
                  ...
                  <li><a href="auth.php" class="nav__link"><img src="images/icons-header/user (1).png" id="icons" alt=""></a></li>
                  <li><a href="#" class="nav__link">
                     
                     <img src="images/icons-header/heart.png" id="icons" alt=""><h4 id="counter">0</h4></a></li>
                  <li><a href="#" class="nav__link"><img src="images/icons-header/shopping-cart.png" id="icons" alt=""></a></li>
